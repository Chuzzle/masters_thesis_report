...
\begin{lemma}
	The waiting time to the next event is exponentially distributed.
\end{lemma}



%The Chapman-Kolmogorov equation in the case of a Markov process can be written: $p_{\xi_j | \xi_i = x_i} \left( x_j \right) = \int_{-\infty}^\infty p_{\xi}$. 

...
To match the questions posed in the goals for this thesis, two types of time dependency was introduced. The first is based on a change in behaviour of the population, leading to an

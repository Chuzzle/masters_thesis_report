...
Each model configuration was run 100 times. This was estimated to be enough to examine the general behaviour of the system, and to give an estimate of the expected behaviour.
...
% Validation results
%			- modelling on system without disease
%			- modelling on the system with disease, but no seasonal variations

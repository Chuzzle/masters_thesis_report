...
There is a clear relationship between age and the distribution of carriage and disease caused by \emph{N. Meningitidis}. Globally, the carriage rates are around 10\%, with high peaks in teenagers and young adults, specifically military recruits and new university students. % what pattern for disease in different regions



% Describe the disease itself, symptoms and also overarching dynamics. Clonal waves.

% Describe the seasonality	DONE
% How the disease spreads	DONE
% Serotypes + different strains of invasiveness + mutations
% Age distribution and immunity and how it relates
% Carriage state + immunization	DONE
